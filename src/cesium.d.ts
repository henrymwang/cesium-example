...
declare module Cesium {
    ...
    class Resource {
        ...
        isDataUri: boolean;
        proxy: DefaultProxy;
        readonly queryParameters: {[queryKey: string]: string};
        request: Request;
        ...
        /** @deprecated */ addQueryParameters(params: {[queryKey: string]: string}, useAsDefault?: boolean): void;
        /** @deprecated */ addTemplateValues(params: {[templateKey: string]: string}, useAsDefault?: boolean): void;
        ...
        fetchImage():  Promise<HTMLImageElement>;
        ...
        setQueryParameters(params: {[queryKey: string]: string}, useAsDefault?: boolean): void;
    ...
    namespace Resource {
        type BaseOptions = {
            headers?: {[headerName: string]: string};
            proxy?: DefaultProxy;
            queryParameters?: {[queryKey: string]: string};
            request?: Request;
            retryAttempts?: number;
            retryCallback?: Resource.RetryCallback;
    ...
    class CzmlDataSource extends DataSource {
        static updaters: any[];
        constructor(name?: string);
        process(data: string | CZMLObject, options?: { sourceUri?: string }): Promise<CzmlDataSource>;
    ...
    namespace EntityCluster {
        ...
        type newClustterCallback = (clusteredEntities: Entity[], cluster: {
            billboard: BillboardGraphics,
            label: LabelGraphics,
            point: PointGraphics
        }) => void;
    ...
    class PointGraphics {
        ...
        pixelSize: Property;
        scaleByDistance: Property;
        show: Property | boolean;   // Hack, see Typescript GH#2521
        translucencyByDistance: Property;
